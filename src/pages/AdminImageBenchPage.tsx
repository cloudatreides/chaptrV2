...
const IMAGE_GEN_AUDIT: ImageGenAction[] = [
  ...
  },
  {
    ...
    notes: 'Currently static. See the PROPOSED row below for the AI-gen path that would replace this with a per-day cinematic establishing shot.',
  },
  {
    feature: 'Day-start scene background (PROPOSED — not in prod)',
    category: 'Travel',
    trigger: '(Proposed) Generate once per day on first day-start view; cache on trip.dayStartImages[dayNumber] so it never re-renders. Show heroImage immediately, cross-fade to AI image when ready.',
    source: '(Not wired yet) src/components/travel/DayTransition.tsx — would call generateTravelImage from a new useEffect when type="start" and !trip.dayStartImages[dayNumber]',
    model: 'Nano Banana (gemini-2.5-flash-image)',
    references: 'twin + companion',
