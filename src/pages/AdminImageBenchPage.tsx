...
const IMAGE_GEN_AUDIT: ImageGenAction[] = [
  ...
  },
  {
    ...
    model: 'Nano Banana (gemini-2.5-flash-image)',
    references: 'twin + companion',
    promptTemplate: 'Randomized at runtime across 5 sensual-but-tasteful framings: Hand on shoulder · Deep kiss tangled sheets · After the shower · Dawn embrace · Fingers intertwined. Each variant takes {playerGender}, {companionDesc}, {destination.city} and produces an anime cel-shaded close-up with explicit "modest tasteful framing" guardrails so chests/waist stay covered.',
    samplePrompts: [
    ...
    notes: 'Step up from Cuddle (+8 affinity vs +5). Prompt is rolled randomly each tap from the variant pool; the modal caption shows the variant label so users can collect the different beats. Models with stricter safety (sometimes Nano Banana 2.5) may still soft-refuse the deep-kiss or after-shower variants — bench all 5 variants × 6 models to map which combos are reliable before locking the variant pool.',
  },
  {
