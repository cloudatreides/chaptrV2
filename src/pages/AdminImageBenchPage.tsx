...
const IMAGE_GEN_AUDIT: ImageGenAction[] = [
  ...
  },
  {
    ...
    notes: 'Tier picked by reference availability and scene.protagonistVisible flag.',
  },
  {
  ...
  },
  {
    ...
    notes: 'Each story step defines its own sceneImagePrompt. Player only — companions described in text. Sample = SCENE_PROMPTS.rehearsal from storyData.ts.',
  },
  {
