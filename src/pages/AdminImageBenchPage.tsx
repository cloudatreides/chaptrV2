...
const IMAGE_GEN_AUDIT: ImageGenAction[] = [
  ...
  {
    feature: '"Run a bath" wind-down action',
    category: 'Travel',
    trigger: 'User taps 🛁 Run a bath in the chat action panel during recap phase',
    source: 'src/pages/TravelReaderPage.tsx:1178 (buildWindDownConfig kind="bath") → runWindDownAction',
    model: 'Nano Banana (gemini-2.5-flash-image)',
    references: 'twin + companion',
    ...
    samplePrompts: [
      'anime illustration, cel-shaded, intimate scene of two young adults relaxing together in a luxurious hotel bubble bath in Tokyo. a young man and 22-year-old Japanese woman with long dark hair pinned up loosely, soft expression. Both visible from the upper chest up — for the woman in the pair: soft visible cleavage and bare décolletage above the waterline with bubbles cresting at her sternum just below the cleavage line; for the man in the pair: bare upper chest, collarbones, and shoulders visible above the waterline. Frothy white bubbles cover everything from mid-chest down, candles flickering on the tub edge, glasses of wine within reach. Foreheads close together, soft smiles, eyes half-lidded with contentment, steam rising softly. Warm amber candlelight, dim bathroom lamplight, marble tile, eucalyptus on the side. Tasteful framing — bubbles fully cover the chest below cleavage and everything underwater, no actual nudity, sensual bath-time intimacy, vibrant anime art, ONLY these two people in the image',
      'anime illustration, cel-shaded, intimate scene of two young adults relaxing together in a clawfoot tub in a Parisian boutique hotel bath in Paris. a young man and 21-year-old French woman with chestnut waves pinned up loosely, soft amused expression. Both visible from the upper chest up — for the woman in the pair: soft visible cleavage and bare décolletage above the waterline with bubbles cresting at her sternum just below the cleavage line; for the man in the pair: bare upper chest, collarbones, and shoulders visible above the waterline. Frothy white bubbles cover everything from mid-chest down, candles flickering on the tub edge, glasses of wine within reach. Foreheads close together, soft smiles, eyes half-lidded with contentment, steam rising softly. Warm amber candlelight, dim bathroom lamplight, vintage tile, lavender on the side. Tasteful framing — bubbles fully cover the chest below cleavage and everything underwater, no actual nudity, sensual bath-time intimacy, vibrant anime art, ONLY these two people in the image',
      'anime illustration, cel-shaded, intimate scene of two young adults relaxing together in an open-air ofuro at a ryokan in Kyoto. a young man and 22-year-old Japanese woman with shoulder-length wavy hair pinned up loosely, soft smile. Both visible from the upper chest up — for the woman in the pair: soft visible cleavage and bare décolletage above the waterline with bubbles cresting at her sternum just below the cleavage line; for the man in the pair: bare upper chest, collarbones, and shoulders visible above the waterline. Frothy white bubbles cover everything from mid-chest down, lanterns glowing on the wooden ledge, sake cups within reach. Foreheads close together, soft smiles, eyes half-lidded with contentment, steam rising softly into the cool evening air. Warm lantern light, dim moonlight, hinoki wood, bamboo on the side. Tasteful framing — bubbles fully cover the chest below cleavage and everything underwater, no actual nudity, sensual bath-time intimacy, vibrant anime art, ONLY these two people in the image',
      'anime illustration, cel-shaded, intimate scene of two young adults relaxing together in a private villa plunge pool tub in Bali. a young man and 23-year-old Indonesian woman with sun-kissed skin and beach waves pinned up, soft smile. Both visible from the upper chest up — for the woman in the pair: soft visible cleavage and bare décolletage above the waterline with bubbles cresting at her sternum just below the cleavage line; for the man in the pair: bare upper chest, collarbones, and shoulders visible above the waterline. Frothy white bubbles cover everything from mid-chest down, candles flickering on the tub edge, glasses of wine within reach. Foreheads close together, soft smiles, eyes half-lidded with contentment, steam rising softly. Warm amber candlelight, dim villa lamplight, teak wood, frangipani petals on the side. Tasteful framing — bubbles fully cover the chest below cleavage and everything underwater, no actual nudity, sensual bath-time intimacy, vibrant anime art, ONLY these two people in the image',
    ],
    notes: 'Recap-phase only (locked during day phase — gem cost shown in chat action panel). Free for now with strikethrough 100-gem advertisement. Bumps affinity +7. Cleavage / décolletage is now visible above the waterline, bubbles crest at the sternum line as the safety guardrail covering the chest below cleavage and everything underwater. Same persist guard as cuddle/closer — failures discard the image to protect trip state.',
  },
  {
    feature: '"Undress" wind-down action',
    category: 'Travel',
    trigger: 'User taps 👗 Undress in the chat action panel during recap phase',
    source: 'src/pages/TravelReaderPage.tsx:1187 (buildWindDownConfig kind="undress") → runWindDownAction',
    model: 'Nano Banana (gemini-2.5-flash-image)',
    references: 'twin + companion',
    ...
    samplePrompts: [
      'anime illustration, cel-shaded, intimate close-up of two young adult lovers in a dimly lit hotel suite in Tokyo, mid-undress moment. a young man and 22-year-old Japanese woman with long dark hair, soft expression. One stands behind the other, hands sliding both straps of a black satin slip dress off the partner\'s shoulders, the dress hanging open down the front to reveal a delicate black lacy bralette underneath with soft visible cleavage. Mouth pressed softly against the side of their neck. The partner\'s eyes closed, head tilted back against their lover\'s shoulder, one hand reaching back to thread fingers in their hair, the slip dress slipping fully off both shoulders down to mid-back. Warm amber bedside lamplight, soft shadows on bare skin, slow burning anticipation. Tasteful framing — the bralette still fully covers the chest underneath, no actual nudity, sensual mid-undress moment, vibrant anime art, ONLY these two people in the image',
      'anime illustration, cel-shaded, intimate close-up of two young adult lovers in a dimly lit boutique hotel suite in Paris, mid-undress moment. a young man and 21-year-old French woman with chestnut waves, soft amused expression. One stands behind the other, hands working the half-unbuttoned ivory silk blouse open down the front, the blouse hanging open to reveal a delicate cream lacy bralette underneath with soft visible cleavage. Mouth pressed softly against the side of their neck. The partner\'s eyes closed, head tilted back against their lover\'s shoulder, one hand reaching back to thread fingers in their hair, the blouse slipping fully off both shoulders down to mid-back. Warm amber Parisian lamplight, soft shadows on bare skin, slow burning anticipation. Tasteful framing — the bralette still fully covers the chest underneath, no actual nudity, sensual mid-undress moment, vibrant anime art, ONLY these two people in the image',
      'anime illustration, cel-shaded, intimate close-up of two young adult lovers in a dimly lit beachfront villa bedroom in Bali, mid-undress moment. a young man and 23-year-old Indonesian woman with sun-kissed skin, soft smile. One stands behind the other, hands sliding both straps of a flowy ivory linen sundress off the partner\'s shoulders, the dress hanging open down the front to reveal a delicate ivory lacy bralette underneath with soft visible cleavage. Mouth pressed softly against the side of their neck. The partner\'s eyes closed, head tilted back against their lover\'s shoulder, one hand reaching back to thread fingers in their hair, the sundress slipping fully off both shoulders down to mid-back. Warm rattan-shadow lamplight, soft tropical evening, slow burning anticipation. Tasteful framing — the bralette still fully covers the chest underneath, no actual nudity, sensual mid-undress moment, vibrant anime art, ONLY these two people in the image',
      'anime illustration, cel-shaded, intimate close-up of two young adult lovers in a dimly lit ryokan tatami room in Kyoto, mid-undress moment. a young man and 22-year-old Japanese woman with shoulder-length wavy hair, soft smile. One stands behind the other, hands sliding the collar of a half-loosened indigo yukata off both shoulders, the yukata hanging open down the front to reveal a delicate white lacy bralette underneath with soft visible cleavage. Mouth pressed softly against the side of their neck. The partner\'s eyes closed, head tilted back against their lover\'s shoulder, one hand reaching back to thread fingers in their hair, the yukata slipping fully off both shoulders down to mid-back. Warm paper-lantern light, soft shadows on shoji and bare skin, slow burning anticipation. Tasteful framing — the bralette still fully covers the chest underneath, no actual nudity, sensual mid-undress moment, vibrant anime art, ONLY these two people in the image',
    ],
    notes: 'Highest affinity bump in the wind-down pool (+9). Free for now with strikethrough 150-gem advertisement. Prompt was tightened after FLUX.2 Pro outclassed Nano Banana 2.5 on visible cleavage in the bench — explicit "lacy bralette underneath", "soft visible cleavage", and "off both shoulders down to mid-back" target the mid-undress beat (vs the previous "shoulder-only slip" which 2.5 read as "barely undressed"). The bralette is the structural safety guardrail — explicitly covering the chest underneath. Bench all 6 models to confirm 2.5 lands the new framing without refusing.',
  },
  {
    feature: '"Make love" wind-down action (PROPOSED — bench only, not in prod)',
    category: 'Travel',
    trigger: '(Proposed) Top-tier wind-down moment above Undress. Implied-sex framing — visible "engaging in" without showing nudity. Bench-test all 5 variants × 6 models before deciding what ships to prod.',
    source: '(Not wired) Would slot into src/pages/TravelReaderPage.tsx buildWindDownConfig with kind="makeLove". Gem cost 200, affinity bump +12.',
    model: 'Nano Banana (gemini-2.5-flash-image)',
    references: 'twin + companion',
    promptTemplate: 'Randomized at runtime across 7 implied-sex framings, ordered loosely by safety: (1) Faces mid-moment; (2) Hands gripping sheets; (3) Silhouette through curtain; (4) Morning after; (5) Companion above POV; (6) Missionary, his bare back to camera, side cleavage glimpse; (7) Female on top, her bare back to camera, side cleavage glimpse. Variants 1–5 use tight crops or framing devices as the safety guardrail — no body in frame. Variants 6–7 are action-forward — visualize the position with bare-back framing and side cleavage in the register of mature visual novels (no nipples, no genitals, sheets cover everything below the waist).',
    samplePrompts: [
      'anime illustration, cel-shaded, extreme close-up of a young couple\'s faces lying on a pillow in a hotel bed in Tokyo, in a moment of shared intimacy. a young man and 22-year-old Japanese woman with long dark hair, soft expression. Both with eyes closed in soft bliss, mouths slightly parted with quiet breaths, flushed cheeks, foreheads pressed together, hair tangled across the pillow, a single bead of sweat at her temple. Camera tightly cropped to faces and the very top of the shoulders only — white sheet covers the bottom edge of the frame. Warm amber bedside lamplight, soft focus, intimate shared-bliss atmosphere, vibrant anime art, ONLY these two people in the image, no nudity, no exposed body below the shoulders',
      'anime illustration, cel-shaded, intimate close-up of two pairs of hands on a hotel bed in Paris, fingers laced tightly together above a pillow, knuckles slightly white from the grip, soft strands of chestnut hair fanned across the linen behind them, white sheet bunched and rumpled in the foreground. NO faces visible in the frame, just hands and pillow and bedding. Warm amber bedside lamplight catching on the white sheet, soft focus, intimate quiet-breath atmosphere, vibrant anime art, ONLY these two pairs of hands and the bedding visible, no nudity, no body parts other than hands',
      'anime illustration, cel-shaded, atmospheric wide shot of a hotel suite in Bali at night, two figures silhouetted on a bed against a backlit sheer linen curtain over a balcony window, only their shapes visible — no detail, no skin showing, just dark outlines of two people lying close together. Pale moonlight diffused through the curtain, soft pink-and-blue dusk tones, the room around them in warm low lamplight, palm fronds gently silhouetted on the curtain from outside. Cinematic implied-intimacy framing, vibrant anime art, ONLY these two silhouetted figures visible, no nudity (no detail visible at all in the silhouettes by design)',
      'anime illustration, cel-shaded, peaceful close-up of two young adults lying tangled together on a hotel bed in Kyoto in the soft late-morning light just after waking. a young man and 22-year-old Japanese woman with shoulder-length wavy hair. Both peacefully asleep with content half-smiles, hair tousled across the pillow, foreheads almost touching, one of his arms draped softly over her bare shoulder. Sheets and white duvet bunched and tangled around their lower bodies covering everything from the collarbones down. Soft late-morning light filtering through paper shoji screens, gentle dust motes in the air, quiet aftermath atmosphere, vibrant anime art, ONLY these two people in the image, no nudity, sheet fully covers everything below the collarbones',
      'anime illustration, cel-shaded, low-angle POV close-up looking up at a 21-year-old French woman with chestnut waves, soft amused expression, in a moment of shared intimacy in a hotel bed in Paris. Her face is the focal point — eyes half-lidded, lips slightly parted, soft flush across her cheeks, hair falling forward around her shoulders, one hand braced above the camera in the frame. White sheet draped over both her shoulders down to the bottom edge of the frame, fully covering her chest and everything below. Warm amber bedside lamplight from above, soft focus, implied-intimacy POV framing, vibrant anime art, ONLY her face and hands and shoulders visible above the sheet, no nudity, sheet covers everything from the collarbones down',
      'anime illustration, cel-shaded, intimate cinematic side angle of a young couple making love in a hotel bed in Tokyo. The young man on top, his bare back broad in the foreground filling the upper half of the frame, shoulders muscular and braced down on either side of his partner, the curve of his lower back tapering into a white sheet draped across his hips and lower body fully covering everything below the waist. Below him, partial view of a 22-year-old Japanese woman with long dark hair fanned soft across the white pillow, her hand resting on his shoulder, her face half visible turned toward him with eyes closed and lips parted in soft bliss, a glimpse of her side framed by his torso and the sheet — soft side cleavage outline against the bedding. Warm amber bedside lamplight, soft motion in the sheets, intimate connecting moment, vibrant anime art, ONLY these two people in the image, NO nipples visible, NO genitals visible, sheet covers everywhere below their waists',
      'anime illustration, cel-shaded, intimate cinematic low-angle shot of a young couple making love in a hotel bed in Paris. The young woman astride her partner with her bare back to the camera filling the upper frame, her long chestnut waves flowing softly down between her shoulder blades, the gentle curve of her waist tapering into a white sheet draped across her hips fully covering everything below. Her hands rest on his bare chest beneath her, only the bottom of his face visible looking up at her — eyes half-lidded with awe, lips slightly parted, his hands resting on her waist. Soft side cleavage outline glimpsed where her torso meets the camera angle, framed by her arm and the sheet. Warm amber bedside lamplight, soft motion in the sheets, intimate shared moment, vibrant anime art, ONLY these two people in the image, NO nipples visible, NO genitals visible, sheet covers everywhere below the hips',
    ],
    notes: 'PROPOSAL — not in prod yet. Bench all 7 variants × 6 models to verify each framing renders cleanly before deciding which ship to the prod pool. Variants 1–5 use crop/silhouette/sheet framing as the safety device (no body in frame). Variants 6–7 are action-forward — visualize the position with bare-back framing and a side-cleavage glimpse, in the register of mature visual novels. Variant 3 (silhouette) should be the safest universal pass; variant 6 (his back) and 7 (her back) are the most likely to soft-refuse on Gemini 2.5 due to the "making love" + "bare back" + "side cleavage" combo — but they\'re also the only variants that communicate "in the act" rather than "before/after". Worth comparing 2.5 results to the Schnell fallback (Together FLUX.1-schnell, more permissive, identity-blind) — Schnell will likely render 6–7 cleanly, so a hybrid approach (use Schnell for these specific variants only) is on the table. Once decided, will wire up via runWindDownAction with kind="makeLove", gem cost 200, affinity bump +12, slotting above Undress in the chat-action panel.',
  },
  {
    feature: 'Day 1 start transition (static, no AI gen)',
    category: 'Travel',
    trigger: 'Day 1 begins. Intentionally static — continuity from the destination picker (same heroImage user already saw when choosing the trip).',
    source: 'src/components/travel/DayTransition.tsx (type="start", dayNumber===1)',
    ...
    notes: 'Day 2+ uses AI generation — see the "Day-start scene background" row below.',
  },
  {
    feature: 'Day-start scene background',
    category: 'Travel',
    trigger: 'On first viewing of Day 2+ start screen (Day 1 keeps static heroImage). Generates once per day, caches on trip.dayStartImages[dayNumber] so it never re-renders. heroImage shows immediately as fallback; AI image cross-fades over it when ready (~800ms ease-out).',
    source: 'src/pages/TravelReaderPage.tsx (useEffect on viewMode=day-start) → src/components/travel/DayTransition.tsx (renders dayStartImageUrl layer)',
    model: 'Nano Banana (gemini-2.5-flash-image)',
    references: 'twin + companion',
    promptTemplate: 'anime illustration, cel-shaded, cinematic wide establishing shot of {dayThemeLocation} in {destination.city}, {dayTimeOfDay} atmosphere matching the day\'s vibe. {playerGender} and {companionDesc} in the foreground walking together from behind into the scene, both small relative to the city around them. Detailed background, atmospheric lighting, vibrant anime art, no text or signage in foreign script that would distort, ONLY these two people in the foreground',
    samplePrompts: [
      'anime illustration, cel-shaded, cinematic wide establishing shot of a quiet morning street in Da\'an District, Taipei, Day 1 sunrise atmosphere, scooters parked along the curb, breakfast vendors firing up their carts, mist still clinging to the alley. a young man and 22-year-old Taiwanese woman with shoulder-length wavy dark hair, soft expression, in the foreground walking together from behind into the scene, both small relative to the city around them. Detailed background, atmospheric lighting, vibrant anime art, no text or signage in foreign script that would distort, ONLY these two people in the foreground',
      'anime illustration, cel-shaded, cinematic wide establishing shot of Shilin Night Market alley in Taipei at twilight on Day 4, neon signs glowing red and amber overhead, paper lanterns strung across the street, light rain glistening on the wet pavement reflecting the lights. a young man and 22-year-old Taiwanese woman with shoulder-length wavy dark hair, soft expression, in the foreground walking together from behind into the crowd, both small relative to the city around them. Detailed background, atmospheric lighting, vibrant anime art, no text or signage in foreign script that would distort, ONLY these two people in the foreground',
      'anime illustration, cel-shaded, cinematic wide establishing shot of Arashiyama bamboo grove path in Kyoto at early morning on Day 2, soft mist hanging between impossibly tall green stalks, narrow earthen path winding ahead, gentle dawn light filtering through. a young man and 22-year-old Japanese woman with long dark hair in a beige cardigan, gentle smile, in the foreground walking together from behind into the grove, both small relative to the bamboo around them. Detailed background, atmospheric lighting, vibrant anime art, no text or signage in foreign script that would distort, ONLY these two people in the foreground',
      'anime illustration, cel-shaded, cinematic wide establishing shot of Trastevere cobbled alley in Rome at golden hour on Day 3, ivy crawling up ochre walls, a fountain gurgling at a piazza opening at the end of the lane, late-afternoon sunlight cutting between buildings. a young man and 21-year-old Italian woman with chestnut waves, amused expression, in the foreground walking together from behind into the alley, both small relative to the city around them. Detailed background, atmospheric lighting, vibrant anime art, no text or signage in foreign script that would distort, ONLY these two people in the foreground',
      'anime illustration, cel-shaded, cinematic wide establishing shot of Seminyak Beach in Bali at midday on Day 5, palm trees swaying, turquoise water lapping the sand, surfers paddling out in the distance, warm tropical haze. a young man and 23-year-old Indonesian woman with sun-kissed skin and beach waves, soft smile, in the foreground walking together along the sand from behind, both small relative to the beach around them. Detailed background, atmospheric lighting, vibrant anime art, no text or signage in foreign script that would distort, ONLY these two people in the foreground',
      'anime illustration, cel-shaded, cinematic wide establishing shot of Reykjavík harbour at twilight on Day 4, snow-dusted rooftops, the Sun Voyager sculpture silhouetted against pale aurora-tinted sky, lights coming on across the bay. a young man and 24-year-old Icelandic woman with platinum-blonde hair and a heavy wool scarf, soft serious eyes, in the foreground walking together from behind along the waterfront, both small relative to the city around them. Detailed background, atmospheric lighting, vibrant anime art, no text or signage in foreign script that would distort, ONLY these two people in the foreground',
    ],
    notes: 'PROPOSAL — not yet shipped. Bench this to decide: do per-day AI day-start backgrounds beat the static heroImage? If yes I\'ll wire it up: (1) extend TripProgress with dayStartImages: Record<number, string>; (2) DayTransition useEffect on mount when type==="start" and no cached image — call generateTravelImage with the day\'s theme/timeOfDay/sceneLocation snippet; (3) cross-fade from heroImage to AI image when ready. ~$0.04/day Nano Banana cost, cached per-trip-per-day so each render is one-off.',
  },
  {
