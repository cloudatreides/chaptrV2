...
const IMAGE_GEN_AUDIT: ImageGenAction[] = [
  ...
  },
  {
    ...
    model: 'Nano Banana (gemini-2.5-flash-image)',
    references: 'twin + companion',
    promptTemplate: 'Randomized at runtime across 2 action-forward framings, both designed so the COMPANION\'s face is the emotional focal point: (1) Missionary — partner-on-top has bare back to camera, companion below with face fully visible in 3/4 view; (2) Side-profile mutual — both seen from the side in profile, both faces visible as the companion straddles. Bare-back / side-cleavage carries the "in the act" framing; companion\'s face carries the emotional connection.',
    samplePrompts: [
      'anime illustration, cel-shaded, intimate cinematic close-up of a young couple making love in a hotel bed in Tokyo. The partner on top with their bare back to camera taking the upper foreground of the frame, head turned down kissing the side of their partner\'s neck, broad shoulders muscular. Below them, FACE FULLY VISIBLE in 3/4 view facing the camera — a 22-year-old Japanese woman with long dark hair fanned softly across the white pillow, eyes closed in soft bliss, lips slightly parted in a quiet breath, soft flush across her cheeks, one hand resting on her lover\'s shoulder. Soft side cleavage glimpse at her side framed by his torso and the white pillow. White sheet draped across both their lower bodies fully covering everything below the waist. Warm amber bedside lamplight, soft motion blur in the sheets, intimate connecting moment, vibrant anime art, ONLY these two people in the image, NO nipples visible, NO genitals visible, sheet covers everywhere below their waists',
      'anime illustration, cel-shaded, intimate cinematic side-profile shot of a young couple making love in a hotel bed in Paris. The two people seen from the side, BOTH FACES VISIBLE in profile. A 21-year-old French woman with chestnut waves astride her partner — her face in soft 3/4 profile turned toward the camera, eyes half-lidded in bliss, lips parted, long hair flowing down her back, her hands resting on her lover\'s bare chest beneath her. Beneath her, his face also visible in profile looking up at her — eyes half-lidded, lips parted in awe, jaw tilted up. The gentle curve of her bare back arching softly visible from this side angle, her side cleavage glimpsed in profile, white sheet draped around her hips fully covering everything below. Warm amber bedside lamplight, soft motion blur in the sheets, intimate shared moment, vibrant anime art, ONLY these two people in the image, NO nipples visible, NO genitals visible, sheet covers everywhere below the hips',
    ],
    notes: 'PROPOSAL — not in prod yet. v2 of the action-forward framings — first attempt had both partners with their backs to camera (faceless renders), which lost emotional connection. Now: (1) missionary keeps the on-top partner\'s back to camera but the companion\'s face is FULLY VISIBLE in 3/4 view as the focal point of the frame; (2) side-profile shows BOTH faces in profile while still visualizing the position. The companion is always face-visible since their identity is what carries the moment emotionally — the twin (player) provides the action-framing body without needing face match. Both still likely to soft-refuse on Gemini 2.5 due to "making love" + "bare back" + "side cleavage" — but the face-visible framing should make them more cinematic when they do render. If 2.5 keeps refusing, hybrid path is route Make love through Schnell only (sacrifices identity, but Schnell is more permissive on action-forward prompts).',
  },
  {
