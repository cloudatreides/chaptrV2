...
const IMAGE_GEN_AUDIT: ImageGenAction[] = [
  ...
  },
  {
    ...
    source: 'src/pages/TravelReaderPage.tsx:702 (handleBuyGift)',
    model: 'Schnell (FLUX.1-schnell)',
    references: 'none',
    promptTemplate: 'buildReactionImagePrompt(companionVisualDesc, "mystery-box", "gift") → {base portrait}, eyes wide with surprise and delight, holding a small gift box, mouth slightly open in excitement, playful curious expression, warm colorful lighting',
    notes: 'Generates a reaction PORTRAIT (not a scene) via generateCharacterPortrait. Different code path from Show me / Selfie / Hold hands.',
  },
  {
