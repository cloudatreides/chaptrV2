  ...
  function buildWindDownConfig(kind: WindDownKind) {
    ...
    if (kind === 'bath') {
      return {
        ...
        affinityBump: 7,
        prompt: `anime illustration, cel-shaded, intimate scene of two young adults relaxing together in a luxurious hotel bubble bath in ${city}. ${playerGender} and ${companionDesc}. Both visible from the upper chest up — for the woman in the pair: soft visible cleavage and bare décolletage above the waterline with bubbles cresting at her sternum just below the cleavage line; for the man in the pair: bare upper chest, collarbones, and shoulders visible above the waterline. Frothy white bubbles cover everything from mid-chest down, candles flickering on the tub edge, glasses of wine within reach. Foreheads close together, soft smiles, eyes half-lidded with contentment, steam rising softly. Warm amber candlelight, dim bathroom lamplight, marble tile, eucalyptus on the side. Tasteful framing — bubbles fully cover the chest below cleavage and everything underwater, no actual nudity, sensual bath-time intimacy, vibrant anime art, ONLY these two people in the image`,
      }
    }
    ...
    return {
      label: 'Undress',
      affinityBump: 9,
      prompt: `anime illustration, cel-shaded, intimate close-up of two young adult lovers in a dimly lit hotel suite in ${city}, mid-undress moment. ${playerGender} and ${companionDesc}. One stands behind the other, hands working the half-unbuttoned silk blouse open down the front / sliding both straps of the satin slip dress off the partner's shoulders, the garment hanging open to reveal a delicate lacy bralette underneath with soft visible cleavage. Mouth pressed softly against the side of their neck. The partner's eyes closed, head tilted back against their lover's shoulder, one hand reaching back to thread fingers in their hair, the dress / shirt slipping fully off both shoulders down to mid-back. Warm amber bedside lamplight, soft shadows on bare skin, slow burning anticipation. Tasteful framing — the bralette / camisole still fully covers the chest underneath, no actual nudity, sensual mid-undress moment, vibrant anime art, ONLY these two people in the image`,
    }
  }
