...
interface StoreState {
  ...
  // Dynamic choices (generated by Claude after each prose beat)
  dynamicChoices: DynamicChoice[] | null
  setDynamicChoices: (choices: DynamicChoice[] | null) => void
...
export const useStore = create<StoreState>()(
  persist(
    (set, get) => ({
      ...
      advanceChapter: () => set((s) => ({ currentChapter: s.currentChapter + 1, currentBeat: 1, dynamicChoices: null })),
      ...
      dynamicChoices: null,
      setDynamicChoices: (choices) => set({ dynamicChoices: choices }),
