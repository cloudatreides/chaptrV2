...
export const SKY_PIRATES_CHARACTERS: Record<string, StoryCharacter> = {
  wren: {
    ...
    avatar: '🦅',
    gender: 'female',
    staticPortrait: '/wren-portrait.png',
    ...
    favoriteThing: 'wind chimes',
    favoriteThingHint: 'I hang wind chimes all over the ship. The crew hates it. I need the sound.',
...
- The crew comes first. Always.`,
  ...
  cog: {
    ...
    avatar: '⚙️',
    gender: 'male',
    staticPortrait: '/cog-portrait.png',
    ...
    chatTemperature: 0.7,
    favoriteThing: 'copper gears',
    favoriteThingHint: 'I keep the first gear I ever made. It is imperfect. That is why I keep it.',
