...
export function FeedbackFab({ onClick }: FeedbackFabProps) {
  return (
    <button
      onClick={onClick}
      className="fixed bottom-5 right-5 z-40 flex items-center gap-1.5 px-3.5 py-2 rounded-full border border-[#3d3060] shadow-lg transition-all hover:scale-105 active:scale-95"
      style={{
