...
const CHARACTERS = [
  ...
  },
  {
    ...
    prompt:
      'Semi-realistic anime portrait illustration with detailed soft natural shading, polished K-drama webtoon art — NOT a flat cartoon, NOT a photograph. Highly detailed illustration of a 22 year old Korean woman, long flowing dark brown hair with subtle blonde balayage highlights, sun-kissed glowing skin with realistic texture and subtle natural blush, big bright warm smile showing teeth, sparkling expressive almond eyes with detailed lashes, wearing a fitted black triangle bikini top with visible cleavage and a small jade pendant necklace, sunny beach setting with rocky shore and pine forest in the background slightly out of focus, soft warm golden afternoon lighting, polished K-drama webtoon aesthetic with subtle realistic skin tones, bold confident beach-babe surf-girl energy. Use the reference photo to guide the facial structure, hair, smile, neckline, and overall composition. Head-and-shoulders to upper-chest framing only.',
  },
  {
    id: 'sora',
